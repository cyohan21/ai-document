        ...
        <div className="mb-6 sm:mb-8">
          <div className="mb-4">
            ...
            <div className="flex flex-wrap justify-between gap-2 sm:gap-3">
              ...
              <a
                href={`/ai-chat?documentName=${encodeURIComponent(documentData.fileName)}`}
                className="inline-flex px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-semibold text-sm sm:text-base"
              >
                Chat with AI
              </a>
            </div>
