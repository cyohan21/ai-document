            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-base sm:text-lg font-semibold text-gray-900 truncate">
                {documentName && documentName.length > 65
                  ...
                  : documentName || 'Voice Chat'}
              </h1>
              <p className="text-xs sm:text-sm text-gray-500">Voice Chat</p>
            </div>
          </a>
        </div>
      </div>
        ...
        <div className="text-center max-w-md w-full">
          ...
          <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-left">
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-sm font-medium text-yellow-800 mb-1">Mobile Browser Notice</p>
                <p className="text-xs text-yellow-700">Voice chat may not work properly on mobile browsers. For the best experience, use a desktop/laptop computer or try text chat instead.</p>
              </div>
            </div>
          </div>
